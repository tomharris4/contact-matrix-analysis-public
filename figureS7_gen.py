...
with open('Output/Reclustering/output_cluster_home_c_adjusted.csv', newline='\n') as csvfile:
...
with open('Output/Reclustering/output_similarity_home_c_adjusted.csv', newline='\n') as csvfile:
    reader = csv.reader(csvfile, delimiter=',', quotechar='"')
    reader.__next__()
    for row in reader:
