...
with open('Output/Reclustering/output_cluster_work.csv', newline='\n') as csvfile:
...
with open('Output/Reclustering/output_similarity_work.csv', newline='\n') as csvfile:
    reader = csv.reader(csvfile, delimiter=',', quotechar='"')
    reader.__next__()
    for row in reader:
